...
private:
  ...
  MoveAnimation
      r_parallel_move; // extra move animations for right small and left small
  ...
  thor::Animator<CharShape, std::string>
      r_parallel_animator; // extra animators for right small and left small
